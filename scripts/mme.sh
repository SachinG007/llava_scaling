...
ROOT=/data/user_data/sachingo/llava_pretraining_data/LLaVA-Eval/MME

# python -m llava.eval.model_vqa_loader \
#     --model-path $MODEL_PATH \
#     --question-file ${ROOT}/llava_mme.jsonl \
#     --image-folder ${ROOT}/MME_Benchmark_release_version \
#     --answers-file ${ROOT}/answers/${CKPT}.jsonl \
#     --temperature 0 \
#     --conv-mode llava_v1
...
python calculation.py --results_dir ./answers/${CKPT} --ckpt_name ${CKPT}