...
#SBATCH --exclude=babel-7-17,babel-4-33,babel-4-37,shire-1-10,babel-15-28,babel-11-13,babel-3-21
#SBATCH --mem=200G
...
# LLM_VERSION_ARRAY=("olmo_7b_token41B" "olmo_7b_token494B" "olmo_7b_token939B" "olmo_7b_token1501B" "olmo_7b_token1874B" "olmo_7b_token2352B" "olmo_7b_token2731B")
...
deepspeed  --master_port=$(shuf -i 44000-54000 -n 1) llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir $OUTPUT_ROOT/checkpoints/llava-${LLM_VERSION_SAVE_NAME}-1e-3pt-1e-5ft-finetune \
    --num_train_epochs 1 \
