...
REVISION_ARRAY=("stage1-step19000-tokens80B" "stage1-step120000-tokens504B" "stage1-step300000-tokens1259B" "stage1-step441000-tokens1850B" "stage1-step584000-tokens2450B" "stage1-step727000-tokens3050B"  "stage1-step928646-tokens3896B")

PROMPT_VERSION=plain #for llama
LLM_VERSION_SAVE_NAME=olmo2-7b--${REVISION_ARRAY[$SLURM_ARRAY_TASK_ID]}
LLM_VERSION="allenai/OLMo-2-1124-7B"
REVISION=${REVISION_ARRAY[$SLURM_ARRAY_TASK_ID]}
