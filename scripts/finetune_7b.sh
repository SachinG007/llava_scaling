...
#SBATCH --partition=candle_15
#SBATCH --account=sachingo
#SBATCH --nodes=1
...
declare -a FINAL_TOKEN_COUNTS=(36 16 4 1)
declare -a KERNELS=(4 6 12 24)
...
LLM_VERSION="/data/user_data/sachingo/Qwen1.5-7B-Chat"
LLM_VERSION_SAVE_NAME="qwen_7b"
