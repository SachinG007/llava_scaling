...
class TokenPacker(nn.Module):
    ...
    def forward(self, x, attn_mask=None):
        ...
        key = self.ln_k_1(self.k_proj_1(x)).permute(1, 0, 2)
        value = self.ln_v_1(self.v_proj_1(x)).permute(1, 0, 2)
