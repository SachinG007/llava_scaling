...
class LlavaOlmoForCausalLM(OlmoForCausalLM, LlavaMetaForCausalLM):
    ...
    def generate(
        ...
        **kwargs,
        ...
        return super().generate(position_ids=position_ids, attention_mask=attention_mask, inputs_embeds=inputs_embeds, tokenizer= self.tokenizer, stop_strings=['assistant', ". ", " .", "\n ", " \n", "  "] ,**kwargs)
